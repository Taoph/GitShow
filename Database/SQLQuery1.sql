...
GO
:setvar DatabaseName "17help"
:setvar DefaultFilePrefix "17help"
:setvar DefaultDataPath "C:\Users\asus\AppData\Local\Microsoft\Microsoft SQL Server Local DB\Instances\ProjectsV13\"
:setvar DefaultLogPath "C:\Users\asus\AppData\Local\Microsoft\Microsoft SQL Server Local DB\Instances\ProjectsV13\"
...
GO
PRINT N'正在创建 [dbo].[Table] 上未命名的约束...';


GO
ALTER TABLE [dbo].[Table] WITH NOCHECK
    ADD CHECK (Age>0 and Age<200);
...
DECLARE tableconstraintnames CURSOR LOCAL FORWARD_ONLY
    FOR SELECT SCHEMA_NAME([schema_id]),
               ...
               0
        FROM   [sys].[objects]
        WHERE  [parent_object_id] IN (OBJECT_ID(N'dbo.Table'))
               AND [type] IN (N'F', N'C')
